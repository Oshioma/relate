-- =============================================================================
-- Relate — allow space_type = 'plant_id' at the CHECK-constraint level
--
-- Rebuilds spaces_space_type_check with the full set including 'plant_id', for
...
alter table public.spaces add constraint spaces_space_type_check
  check (space_type::text in (
    ...
    'course', 'crop_guides', 'plant_scanner', 'my_crops', 'plant_id'
  ));
