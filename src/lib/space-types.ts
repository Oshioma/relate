...
// All types except 'challenges', 'gallery', 'qa', and 'custom' have dedicated
// rendering (see src/app/c/[communitySlug]/spaces/[spaceSlug]/page.tsx); the
// rest still fall back to the plain discussion feed.
