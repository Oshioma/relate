...
const TABS = [
  { href: "/platform-admin", label: "Settings", match: ["/platform-admin/communities", "/platform-admin/users", "/platform-admin/analytics", "/platform-admin/legal", "/platform-admin/system"] },
  ...
  { href: "/platform-admin/legal", label: "Legal", match: ["/platform-admin/legal"] },
